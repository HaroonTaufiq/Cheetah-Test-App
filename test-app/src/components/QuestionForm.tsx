...
import { Step1Data } from '@/app/types/survey'

export default function QuestionOneForm() {
  ...
  return (
    <>
      <div className="text-center space-y-4 pt-48 lg:pt-0">
      ...
      >
        ...
        >
          ...
          <div className="bg-zinc-800/50 p-6 rounded-xl w-full aspect-square flex items-center justify-center">
